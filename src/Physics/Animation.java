...
public class Animation {
    ...
    public static ArrayList<String> landingL() {
        ArrayList<String> landingL = new ArrayList<>();
        makeAnimationLonger(2, landingL, "images/jumpL/jump26L.png");
        makeAnimationLonger(2, landingL, "images/jumpL/jump27L.png");
        makeAnimationLonger(2, landingL, "images/jumpL/jump28L.png");
        makeAnimationLonger(2, landingL, "images/jumpL/jump29L.png");
        makeAnimationLonger(2, landingL, "images/jumpL/jump30L.png");
        makeAnimationLonger(2, landingL, "images/jumpL/jump31L.png");
        makeAnimationLonger(2, landingL, "images/jumpL/jump32L.png");
        makeAnimationLonger(2, landingL, "images/jumpL/jump33L.png");
        return landingL;
    }

    public static ArrayList<String> landingR() {
        ArrayList<String> landingR = new ArrayList<>();
        makeAnimationLonger(2, landingR, "images/jump/jump26.png");
        makeAnimationLonger(2, landingR, "images/jump/jump27.png");
        makeAnimationLonger(2, landingR, "images/jump/jump28.png");
        makeAnimationLonger(2, landingR, "images/jump/jump29.png");
        makeAnimationLonger(2, landingR, "images/jump/jump30.png");
        makeAnimationLonger(2, landingR, "images/jump/jump31.png");
        makeAnimationLonger(2, landingR, "images/jump/jump32.png");
        makeAnimationLonger(2, landingR, "images/jump/jump33.png");
        return landingR;
    }
